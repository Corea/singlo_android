...
import com.kapp.singlo.http.HttpPost;
		...
		if (HttpPost.check_version(mainActivity.getBaseContext())==true) { // 버젼체크
			...
			.setPositiveButton("예", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.kapp.timelotto")));
