 ...
 */
public class SettingBoard extends SingloUserActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = ProgressDialog.show(SettingBoard.this, "", "준비중입니다.", true,
                false);
    ...
    private BoardAction.BoardListener mBoardListener = new BoardAction.BoardListener() {
        ...
        public void result(ArrayList<BoardAction.Article> articleArrayList) {
            if (articleArrayList != null) {
                SettingBoard.this.articleArrayList = articleArrayList;
